...
struct snorm8
{
    ...
    snorm8(float v) : value(int8_t(v * 127.0f)) {}
...
struct unorm8
{
    ...
    unorm8(float v) : value(uint8_t(v * 255.0f)) {}
...
struct snorm16
{
    ...
    snorm16(float v) : value(int16_t(v * 32767.0f)) {}
...
struct unorm16
{
    ...
    unorm16(float v) : value(uint16_t(v * 65535.0f)) {}
