...
mark_as_advanced(MAYA2016_5_INCLUDE_DIR)
foreach(MAYA_LIB OpenMayaAnim OpenMayaFX OpenMayaRender OpenMayaUI OpenMaya Foundation)
    find_file(MAYA2016_5_${MAYA_LIB}_LIBRARY lib${MAYA_LIB}${CMAKE_SHARED_LIBRARY_SUFFIX} PATH_SUFFIXES lib MacOS)
    mark_as_advanced(MAYA2016_5_${MAYA_LIB}_LIBRARY)
    if(MAYA2016_5_${MAYA_LIB}_LIBRARY)
        list(APPEND MAYA2016_5_LIBRARIES ${MAYA2016_5_${MAYA_LIB}_LIBRARY})
    endif()
endforeach()
