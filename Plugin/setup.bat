...
IF NOT EXIST "External\ispc.exe" (
    IF NOT EXIST "External\External.7z" (
        ...
        powershell.exe -Command "(new-object System.Net.WebClient).DownloadFile('https://github.com/i-saint/MeshSync/releases/download/0.0.2/External.7z', 'External/External.7z')"
    )
    cd External
