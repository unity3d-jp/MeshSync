...
mkdir "%DIST_DIR_MQ3%"
copy _out\x64_Release\MeshSyncClientMQ4.dll "%DIST_DIR_MQ4_64%"
copy _out\Win32_Release\MeshSyncClientMQ4.dll "%DIST_DIR_MQ4_32%"
copy _out\Win32_Release\MeshSyncClientMQ3.dll "%DIST_DIR_MQ3%"
