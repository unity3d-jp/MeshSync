...
#define BindProperty(Name, ...) .def_property(#Name, __VA_ARGS__)
    {
        ...
        py::class_<msbContext, msbContextPtr>(mod, "Context")
            ...
            BindProperty(keep_empty_curves,
                [](const msbContext& self) { return self.getSettings().keep_empty_curves; },
                [](msbContext& self, int v) { self.getSettings().keep_empty_curves = v; })
