...
def msb_apply_animation_settings(self = None, context = None):
    ...
    ctx.keep_empty_curves = scene.meshsync_animation_kec
    return None
...
def msb_initialize_properties():
    ...
    bpy.types.Scene.meshsync_animation_kec = bpy.props.BoolProperty(default = False, name = "Keep Empty Curves", update = msb_on_animation_settings_updated)
