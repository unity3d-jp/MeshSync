...
//----------------------------------------------------------------------------------------------------------------------
    private void ValidatePlayerConfigs() {
        ...
        if (null == m_defaultServerConfig) {
            ...
            m_defaultServerConfig.SetModelImporterSettings(new ModelImporterSettings(syncMaterials:true));
        }
        ...
        if (null == m_defaultSceneCachePlayerConfig) {
            ...
            m_defaultServerConfig.SetModelImporterSettings(new ModelImporterSettings(syncMaterials:false));
        }         
    }
