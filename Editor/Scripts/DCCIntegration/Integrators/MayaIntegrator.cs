...
namespace Unity.MeshSync.Editor {
    ...
    internal class MayaIntegrator : BaseDCCIntegrator {
        ...
        internal override bool ConfigureDCCToolV(DCCToolInfo dccToolInfo, string srcPluginRoot,
            ...
            // Auto Load
            var arg = string.Format(argFormat, loadPluginCmd + FINALIZE_SETUP);
            var setupSuccessful = SetupAutoLoadPlugin(dccToolInfo.AppPath, arg);
        ...
        protected override void FinalizeDCCConfigurationV() {
            ...
            EditorUtility.DisplayDialog("MeshSync",
                $"Launching {dccToolInfo.GetDescription()} to finalize configuration",
                "Ok"
            );
        }
