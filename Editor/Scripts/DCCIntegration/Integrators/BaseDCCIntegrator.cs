...
//----------------------------------------------------------------------------------------------------------------------    
    internal DCCToolInfo GetDCCToolInfo() {
        return m_dccToolInfo;
    }
    ...
    internal void SetLastErrorMessage(string msg) {
...
//----------------------------------------------------------------------------------------------------------------------    
    ...
    private static void HandleFailedIntegration(string errMessage, string dccDesc) {
        Debug.LogError($"[MeshSync] Error when installing plugin for {dccDesc}. {Environment.NewLine} " +
            $"Message:  {errMessage}");
        EditorUtility.ClearProgressBar();
