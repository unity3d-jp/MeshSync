...
internal class MeshSyncEditorSettings : ISerializationCallbackReceiver {
    ...
    internal static string GetSettingsPath() {
        return MESHSYNC_EDITOR_SETTINGS_PATH;
    }

//----------------------------------------------------------------------------------------------------------------------

    //Constructor
    private MeshSyncEditorSettings() {
...
//----------------------------------------------------------------------------------------------------------------------
    internal bool RemoveDCCTool(string appPath) {
        if (!m_dictionary.ContainsKey(appPath)) return false;
...
//----------------------------------------------------------------------------------------------------------------------
    ...
    internal bool AddInstalledDCCTools() {
        ...
        foreach (KeyValuePair<string, DCCToolInfo> dcc in dccPaths) {
...
//----------------------------------------------------------------------------------------------------------------------
    ...
    private static MeshSyncEditorSettings LoadEditorSettings() {
...
//----------------------------------------------------------------------------------------------------------------------
    ...
    public void OnAfterDeserialize() {
        ...
        foreach (DCCToolInfo info in m_serializedDCCToolInfo) {
            if (m_dictionary.ContainsKey(info.AppPath)) continue;
...
//----------------------------------------------------------------------------------------------------------------------
    ...
    internal IDictionary<string, DCCToolInfo> GetDCCToolInfos() {
        return m_dictionary;
    }
...
//----------------------------------------------------------------------------------------------------------------------
    ...
    private const string MESHSYNC_EDITOR_SETTINGS_PATH = "Library/MeshSync/MeshSyncEditorSettings.asset";
