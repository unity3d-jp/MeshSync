...
internal class SceneServerSettingsTab : IMeshSyncSettingsTab {
...
//----------------------------------------------------------------------------------------------------------------------        
    public void Setup(VisualElement root) {
        ...
        VisualTreeAsset tab = UIElementsEditorUtility.LoadVisualTreeAsset(Constants.MAIN_USER_SETTINGS_PATH);	    
