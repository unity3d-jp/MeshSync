...
internal class KeyFrameMarkerInspector : UnityEditor.Editor {
    private void OnEnable() {
        ...
        for (int i = 0; i < numTargets; i++) m_assets[i] = targets[i] as KeyFrameMarker;
    }
...
//----------------------------------------------------------------------------------------------------------------------
    public override void OnInspectorGUI() {
        ...
        if (1 == m_assets.Length) {
            ...
            if (null == firstPlayableKeyFrame) return;
            ...
            for (int i = 1; i < numSelectedAssets; ++i) {
                ...
                if (playableKeyFrame.GetUserNote() != prevNote) prevNote = "<different notes>";
            }
...
//----------------------------------------------------------------------------------------------------------------------
    ...
    private Vector2          m_noteScroll = Vector2.zero;
}
} //end namespace