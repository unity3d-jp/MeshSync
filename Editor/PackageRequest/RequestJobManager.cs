...
//---------------------------------------------------------------------------------------------------------------------
    ...
    static readonly System.Collections.Generic.HashSet<IRequestJob> m_requestJobs = new HashSet<IRequestJob>();
    static readonly System.Collections.Generic.List<IRequestJob> m_jobsToDelete = new List<IRequestJob>();
