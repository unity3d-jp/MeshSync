...
//----------------------------------------------------------------------------------------------------------------------
    ...
    private void DeleteSceneCachePlayerPrefab(GameObject prefab) {
        Assert.IsTrue(prefab.IsPrefab());
        ...
        //Cleanup
        foreach (string guid in prefabAssetGUIDs) AssetDatabase.DeleteAsset(AssetDatabase.GUIDToAssetPath(guid));
...
//----------------------------------------------------------------------------------------------------------------------
    ...
    private static TestDataComponents ChangeSceneCacheFileAndVerify(SceneCachePlayer player, string scPath) {
    ...
    private class TestDataComponents {
