...
{
    static constexpr tvec2<T> value = { inf_impl<T>::value, inf_impl<T>::value };
};

template<class T> struct inf_impl<tvec3<T>>
{
    static constexpr tvec3<T> value = { inf_impl<T>::value, inf_impl<T>::value, inf_impl<T>::value };
};

template<class T> struct inf_impl<tvec4<T>>
{
    static constexpr tvec4<T> value = { inf_impl<T>::value, inf_impl<T>::value, inf_impl<T>::value, inf_impl<T>::value };
};

template<class T> struct inf_impl<tquat<T>>
{
    static constexpr tquat<T> value = { inf_impl<T>::value, inf_impl<T>::value, inf_impl<T>::value, inf_impl<T>::value };
};
